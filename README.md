...
```bash
pip install git+https://github.com/jroslaniec/django-msg@0.1.0#egg=msg
```
...
```bash
pip install git+https://github.com/jroslaniec/django-msg@0.1.0#egg=msg[celery]
pip install git+https://github.com/jroslaniec/django-msg@0.1.0#egg=msg[boto3]
pip install git+https://github.com/jroslaniec/django-msg@0.1.0#egg=msg[twilio]
pip install git+https://github.com/jroslaniec/django-msg@0.1.0#egg=msg[all]
```
